...
namespace Shortly.Client.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public AuthenticationController(IUsersService usersService, SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> SendEmailConfirmation(ConfirmEmailLoginVM confirmEmailLoginVM)
        {
            ...
            if (user != null)
            {
                ...
                var userConfirmationLink = Url.Action(
                    "EmailConfirmationVerified", 
                    "Authentication",
                    new { userId = user.Id, userConfirmationToken = userToken }, 
                    Request.Scheme);
